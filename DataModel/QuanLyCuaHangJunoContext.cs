...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.MaPhieuDat, e.MaSp })
                    .HasName("PK__DatHang___D3985DAAB127DEC5");
                ...
                entity.HasOne(d => d.MaSpNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_dh_sp_SanPham");
            });

            modelBuilder.Entity<GiamGiaHoaDon>(entity =>
            {
                entity.HasKey(e => e.MaGg)
                    .HasName("PK__GiamGiaH__2725AE8290A199CC");
            ...
            modelBuilder.Entity<HoaDonBanHang>(entity =>
            {
                entity.HasKey(e => e.MaHd)
                    .HasName("PK__HoaDonBa__2725A6E0F2AE798D");
            ...
            modelBuilder.Entity<HoaDonBanHangSanPham>(entity =>
            {
                entity.HasKey(e => new { e.MaHd, e.MaSp })
                    .HasName("PK__HoaDonBa__F557F661320C1178");
                ...
                entity.HasOne(d => d.MaSpNavigation)
                    ...
                    .HasForeignKey(d => d.MaSp)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_HoaDonBanHang_SanPham_SanPham");
            });

            modelBuilder.Entity<KhachHang>(entity =>
            {
                entity.HasKey(e => e.MaKh)
                    .HasName("PK__KhachHan__2725CF1EC227E2BD");
            ...
            modelBuilder.Entity<KhuyenMai>(entity =>
            {
                entity.HasKey(e => e.MaKm)
                    .HasName("PK__KhuyenMa__2725CF15106CA63C");
            ...
            modelBuilder.Entity<KhuyenMaiSanPham>(entity =>
            {
                entity.HasKey(e => new { e.MaKm, e.MaSp })
                    .HasName("PK__KhuyenMa__F5579F9414396AFA");
            ...
            modelBuilder.Entity<KichCo>(entity =>
            {
                entity.HasKey(e => e.MaKc)
                    .HasName("PK__KichCo__2725CF03E90650D3");
            ...
            modelBuilder.Entity<LoaiSanPham>(entity =>
            {
                entity.HasKey(e => e.MaLoaiSp)
                    .HasName("PK__LoaiSanP__1224CA7C6DFF0D68");
            ...
            modelBuilder.Entity<Mau>(entity =>
            {
                entity.HasKey(e => e.MaMau)
                    .HasName("PK__Mau__3A5BBB7DF67A7BD7");
            ...
            modelBuilder.Entity<NhanVien>(entity =>
            {
                entity.HasKey(e => e.MaNv)
                    .HasName("PK__NhanVien__2725D70AAA63047E");
            ...
            {
                entity.HasKey(e => new { e.MaPhNhap, e.MaSp })
                    .HasName("PK__NhapHang__E6944108D19281A0");
                ...
                entity.HasOne(d => d.MaSpNavigation)
                    ...
                    .HasForeignKey(d => d.MaSp)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_nh_sp_SanPham");
            });

            modelBuilder.Entity<PhieuBaoHanh>(entity =>
            {
                entity.HasKey(e => e.MaPhieu)
                    .HasName("PK__PhieuBao__2660BFE04A362810");
            ...
            modelBuilder.Entity<PhieuDatHang>(entity =>
            {
                entity.HasKey(e => e.MaPhieuDat)
                    .HasName("PK__PhieuDat__01EA0D2B73C3427A");
            ...
            modelBuilder.Entity<PhieuNhapHang>(entity =>
            {
                entity.HasKey(e => e.MaPhNhap)
                    .HasName("PK__PhieuNha__34E611894FE157FE");
            ...
            modelBuilder.Entity<PhieuTraHang>(entity =>
            {
                entity.HasKey(e => e.MaPhieuTra)
                    .HasName("PK__PhieuTra__1D880A4600D5E00D");
            ...
            modelBuilder.Entity<SanPham>(entity =>
            {
                entity.HasKey(e => e.MaSp)
                    .HasName("PK__SanPham__2725081CBD03971E");
            ...
            modelBuilder.Entity<SanPhamChiTiet>(entity =>
            {
                entity.HasKey(e => e.MaSpCt)
                    .HasName("PK__SanPham___2478B453A606AFB7");
